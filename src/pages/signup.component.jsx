...
const Signup = () => {
    ...
    return (
        <div className='flex sm:flex-col flex-row justify-between' style={{ backgroundColor: '#211B34' }}>
            ...
            <div className='flex flex-col sm:px-6 sm:pt-4 sm:pb-12 p-32 space-y-6 flex-grow text-white'>
                <div className='flex flex-col text-left space-y-3'>
                    <h2 className='font-bold text-2xl'>Create Account</h2>
                    <span className="text-gray-300">Set up your account</span>
                </div>
                <form onSubmit={()=> console.log('submitted')} className='space-y-6'>
                    ...
                    <div className='flex flex-col space-y-1 text-left'>
                        ...
                        <input type='password' placeholder='Enter your country'/>                        
                    </div>
                    <div className='flex-grow'>
                        <button className='w-full h-12 rounded-lg text-white' style={{ backgroundColor: '#403D50' }}>Sign up</button>
                    </div>
                </form>
                <div className='text-left flex flex-col space-y-3'>
                    <span>Have an account? <Link to='/login' className='font-semibold text-gray-300'>Login</Link></span>
                </div>
            </div>
